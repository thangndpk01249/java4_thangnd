<%-- 
    Document   : giohang
    Created on : Apr 13, 2022, 8:07:45 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        <a href="homeControler" class="btn btn-info" role="button">Mua Hàng tiếp</a>
          <a href="#" class="btn btn-success" role="button">Thanh toán</a>
